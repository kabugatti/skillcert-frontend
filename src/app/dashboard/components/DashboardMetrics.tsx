...
const DashboardMetrics: React.FC<DashboardMetricsProps> = ({ metrics }) => (
  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10 max-w-[85%] mx-auto">
    {metrics.map((metric, idx) => (
      <div key={idx} className="bg-gray-800 rounded-xl p-7 flex flex-row items-center shadow-md min-h-[140px]">
