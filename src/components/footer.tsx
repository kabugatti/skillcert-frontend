        ...
        <div className="grid grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <Link href="#" className="text-white hover:text-purple-400 transition-colors" aria-label="Telegram">
              ...
              <Link href="#" className="text-white hover:text-purple-400 transition-colors" aria-label="Discord">
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
